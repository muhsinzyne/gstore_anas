...
if (localStorage.languageCode == undefined) {
  localStorage.languageCode = "ml"; //default language code
...
export class ConfigService {
  ...
  public url: string = 'https://gstore.goit.in';
  public consumerKey: string = 'ck_5e3e387179af5db34d48b8302bd2f71f3bb95963';
  public consumerSecret: string = 'cs_11813a0c743303486a8c56a055710bc13916c15e';
  public locationIQToken: string = 'pk.2ca32e7f18b2a4d27b1001db87aa62f5';
  public locationIQendPoint: string = 'https://us1.locationiq.com/';

  
  public askAddressOnStart: boolean  = true;
